              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" name="leave_type_id" id="leave_type_id" onchange="clearDates()" required>
                      ...
                      @else
                      <option value="{{$lt->id}}" {{ ($leaveApplication->leave_type_id == $lt->id ? "selected":"") }}>{{$lt->name}}
                      </option>
                      @endif
                      @endforeach
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" name="apply_for" value="{{old('apply_for')}}">
                      <option value="full-day" {{ ($leaveApplication->apply_for == 'full-day' ? "selected":"") }}>Full Day</option>
                      <option value="half-day-am" {{ ($leaveApplication->apply_for == 'half-day-am' ? "selected":"") }}>Half Day AM
                      </option>
                      <option value="half-day-pm" {{ ($leaveApplication->apply_for == 'half-day-pm' ? "selected":"") }}>Half Day PM
                      </option>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="date" class="form-control float-right" name="date_from" id="FromDate" value="{{$leaveApplication->date_from}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="date" class="form-control float-right" name="date_to" id="ToDate" value="{{$leaveApplication->date_to}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="date" class="form-control float-right" name="date_resume" id="ResumeDate" value="{{$leaveApplication->date_resume}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="file" class="form-control-file" name="attachment" id="attachment" value="{{isset($leaveApplication->attachment_url)? $leaveApplication->attachemnt_url:''}}">
                    @if($leaveApplication->attachment_url == null)
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" name="relief_personnel_id" required>
                      ...
                      <option value="{{$emp->id}}" {{ ($leaveApplication->relief_personnel_id == $emp->id ? "selected":"") }}>
                        {{$emp->name}}
                      </option>
                      @endforeach
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control float-right" name="emergency_contact_name" value="{{$leaveApplication->emergency_contact_name}}" required {{isset($leaveApplication->emergency_contact_name) ? "readonly":''}}>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control float-right" name="emergency_contact_no" value="{{$leaveApplication->emergency_contact_no}}" required {{isset($leaveApplication->emergency_contact_no) ? "readonly":''}}>
                    <div class="invalid-feedback">
                      Please update your emergency contact at "Edit My Profile" or fill it in here
                    </div>
                  </div>
