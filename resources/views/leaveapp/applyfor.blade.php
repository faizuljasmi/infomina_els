                    ...
                    <form class="needs-validation" novalidate method="POST" action="{{route('submit_apply_for',$user)}}"
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Added by GR -->
                                <input type="hidden" id="user_state" value="{{$user->state->id}}"/>
      ...
      _totalDay : function(name){
        if(validation.isHalfDayAm() || validation.isHalfDayPm()){
          ...
          if(!_form.isEmpty(FC.date_from) && !_form.isEmpty(FC.date_to)){
            ...
            let hasError = false;
            if(validation.isUnpaidLeave() || validation.isHospitalizationLeave() || validation.isMaternityLeave() || validation.isPaternityLeave() || userGroup == 'Support Engineer' || userGroup == 'ICSC' || userGroup == 'Helpdesk' || userGroup == 'Service Delivery (Technical)'){
