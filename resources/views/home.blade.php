...
<section class="content">
  <div class="container-fluid">
    ...
    <h5>Balance Overview: <a href="#leaveRecord"><button type="button" class="btn btn-primary btn-sm">More Info</button></i></a></h5>
    <div class="row">
          ...
          <div class="card-body">
            <table class="table table-sm table-bordered">
              <tbody>
                ...
                <tr>
                  <th>Brought Forward <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Brought forward leave from 2019"></i>
                  </th>
                ...
                <tr>
                  <th>Replacement <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Claimed replacement leave will be put here and added to your annual leave balance"></i></th>
                  @foreach($leaveEarns as $le)
                  @if($le->leave_type_id == "12")
                ...
                <tr>
                  <th>Burnt <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Unused brought forward leaves will go here on 1 July"></i></th>
                  @foreach($leaveEnts as $le)
                  @if($le->leave_type_id != '12')
